    ...
    return (
        <div className="text-white text-left font-mono text-lg mt-12">
            <h4>
                ...
                l'apprentissage
                pratique. Équipé de technologies de pointe telles que des imprimantes 3D, des serveurs, et une variété
            ...
            <ul className="list-disc">
                ...
                <li><a className="font-bold">Calendrier des Activités</a> : Restez informé des ateliers, des formations
                    et des
                    événements spéciaux organisés dans le laboratoire.
                </li>
                <li><a className="font-bold">Ressources et Tutoriels</a> : Accédez à une bibliothèque de ressources et
                    de tutoriels
                    pour vous aider à maîtriser les outils et les technologies disponibles.
                </li>
            </ul>
